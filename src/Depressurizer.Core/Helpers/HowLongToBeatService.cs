...
namespace Depressurizer.Core.Helpers
{
    ...
    public class HowLongToBeatEntry
    {
        ...
        public HowLongToBeatEntry(string id)
        {
            Id = id;
        }
    ...
    public class HltbSearch
    {
        ...
        /// </summary>
        public static string SEARCH_URL = $"{BASE_URL}api/search/3ef777b4d4ae0be0";
        ...
        public async Task<string> DetailHtml(string gameId, CancellationToken? cancellationToken = null)
        {
            try
            {
                string userAgent = "Mozilla/5.0 (X11; U; Linux x86_64; en-US; rv:1.9.2a1pre) Gecko/20090428 Firefox/3.6a1pre";
